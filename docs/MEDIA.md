...
**Mise à jour 2026-07-02** : S-01, G-01 et S-09 (modal d'activation, cf. NEXT_STEPS §D.3) sont produits dans `docs/media/` — l'image du README fonctionne. Le reste est encore à produire.
...
|---|---|---|---|
| S-01 | `docs/media/screenshot-organize.png` | Onglet **Organisation**, source/dest remplis, critères Date+Caméra cochés (spec post-pivot, NEXT_STEPS §D.3) | ✅ produit 2026-07-02 (1920×1200) |
| S-02 | `docs/media/screenshot-organize-running.png` | Onglet Organisation en cours d'exécution, progress bar à ~60 %, log scroll | 🔴 P0 |
| S-09 | `docs/media/screenshot-unlock-modal.png` | Panneau d'activation inline (limite atteinte, champ clé, bouton Acheter) — "S-02" dans NEXT_STEPS §D.3 | ✅ produit 2026-07-02 (1280×800) |
...
|---|---|---|---|---|
| G-01 | `docs/media/demo-organize.gif` | Sélection dossier → choix critères → clic Organiser → progress → résultat | 8-10 s | ✅ produit 2026-07-02 (0,72 MB, ~10,8 s, 960×600) |
...
- [x] S-01 et G-01 sont à jour (sinon le README a un lien cassé). *(produits le 2026-07-02)*
