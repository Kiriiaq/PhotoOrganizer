# -*- coding: utf-8 -*-
"""Compare ``test/outputs_reels/`` à ``test/outputs_reference/``.
...
Le rapport sort en stdout + dans ``test/outputs_reels/_diff_report.md``.

Usage :
    python test/scripts/compare_outputs.py
    python test/scripts/compare_outputs.py --only T-051
"""
...
REF_DIR = ROOT / "test" / "outputs_reference"
REAL_DIR = ROOT / "test" / "outputs_reels"
