...
Tous les inputs sont créés sous ``test/inputs/`` à partir de photos PIL
synthétiques (rapide, reproductible, EXIF maîtrisé via piexif).

Usage :
    python test/scripts/generate_inputs.py
    python test/scripts/generate_inputs.py --large  # input_volumineux à 1000
"""
