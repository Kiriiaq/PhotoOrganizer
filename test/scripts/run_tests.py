...
Usage :
    python test/scripts/run_tests.py              # tous les scénarios
    python test/scripts/run_tests.py --only T-051 # un test précis
    python test/scripts/run_tests.py --list       # liste sans exécution
"""
...
INPUTS_DIR  = ROOT / "test" / "inputs"
OUTPUTS_DIR = ROOT / "test" / "outputs_reels"
